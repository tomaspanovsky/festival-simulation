...
Uživatelské rozhraní je realizováno pomocí knihovny Tkinter a jejího rozšíření CustomTkinter, které zajišťují vykreslování oken, ovládacích prvků a interaktivních prvků editoru festivalového areálu. Logika aplikace je oddělena od grafické vrstvy, což umožňuje přehlednou správu dat a snadnější rozšiřování funkcionality.
...
Tato architektura umožňuje snadné rozšiřování aplikace o nové typy objektů, zón, chování návštěvníků nebo vizualizační prvky, aniž by bylo nutné zásadně měnit strukturu celého systému.
